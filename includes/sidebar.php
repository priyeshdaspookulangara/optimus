    ...
    <div class="sidebar-body p-0 data-scrollbar">
      <div class="navbar-collapse pe-3" id="sidebar">
        <ul class="navbar-nav iq-main-menu">
          ...
          <li class="nav-item"><a class="nav-link" href="sponsor_tree.php"><i class="icon fa fa-sitemap"></i><span class="item-name">Sponsor Tree</span></a></li>
          <li class="nav-item"><a class="nav-link" href="binary_tree.php"><i class="icon fa fa-network-wired"></i><span class="item-name">Binary Tree</span></a></li>
