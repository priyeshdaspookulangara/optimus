...
<body>
    <div class="sidebar">
        ...
        <a href="rank_commission_reset.php" id="link-rank-commission-reset" class="<?php echo basename($_SERVER['PHP_SELF']) == 'rank_commission_reset.php' ? 'active' : ''; ?>"><i class="fa fa-sync me-2"></i> Rank & ROI Reset</a>
        <hr>
