...
<body>
    <div class="sidebar">
        ...
        <a href="correct_rank_income.php" id="link-correct-rank-income" class="<?php echo basename($_SERVER['PHP_SELF']) == 'correct_rank_income.php' ? 'active' : ''; ?>"><i class="fa fa-sync-alt me-2"></i> Recalculate Rank Income</a>
        <hr>
