...
<body>
    <div class="sidebar">
        ...
        <a href="calculate_rank_income.php" id="link-calc-rank-income" class="<?php echo basename($_SERVER['PHP_SELF']) == 'calculate_rank_income.php' ? 'active' : ''; ?>"><i class="fa fa-calculator me-2"></i> Calculate Rank Income</a>
        <hr>
