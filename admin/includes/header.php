...
<body>
    <div class="sidebar">
        ...
        <a href="clean_duplicate_withdrawals.php" id="link-clean-withdrawals" class="<?php echo basename($_SERVER['PHP_SELF']) == 'clean_duplicate_withdrawals.php' ? 'active' : ''; ?>"><i class="fa fa-broom me-2"></i> Clean Duplicate Withdrawals</a>
        <hr>
