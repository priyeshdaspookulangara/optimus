...
<body>
    <div class="sidebar">
        ...
        <a href="recalculate_rank.php" id="link-recalculate" class="<?php echo basename($_SERVER['PHP_SELF']) == 'recalculate_rank.php' ? 'active' : ''; ?>"><i class="fa fa-sync me-2"></i> Recalculate Rank</a>
        <hr>
