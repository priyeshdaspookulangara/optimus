...
<body>
    <div class="sidebar">
        ...
        <a href="printree.php" id="link-tree" class="<?php echo basename($_SERVER['PHP_SELF']) == 'printree.php' || basename($_SERVER['PHP_SELF']) == 'tree.php' ? 'active' : ''; ?>"><i class="fa fa-sitemap me-2"></i> Downline Tree</a>
