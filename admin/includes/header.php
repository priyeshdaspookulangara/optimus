...
<body>
    <div class="sidebar">
        ...
        <a href="placement_conflicts.php" id="link-placement-conflicts" class="<?php echo basename($_SERVER['PHP_SELF']) == 'placement_conflicts.php' ? 'active' : ''; ?>"><i class="fa fa-sitemap me-2"></i> Placement Conflicts</a>
        <hr>
