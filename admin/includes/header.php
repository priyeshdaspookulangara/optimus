...
<body>
    <div class="sidebar">
        ...
        <a href="daily_summary.php" id="link-daily-summary" class="<?php echo basename($_SERVER['PHP_SELF']) == 'daily_summary.php' ? 'active' : ''; ?>"><i class="fa fa-calendar-day me-2"></i> Daily Summary</a>
