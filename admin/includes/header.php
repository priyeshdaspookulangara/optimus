...
<body>
    <div class="sidebar">
        ...
        <a href="reset_commissions.php" id="link-reset-commissions" class="<?php echo basename($_SERVER['PHP_SELF']) == 'reset_commissions.php' ? 'active' : ''; ?>"><i class="fa fa-calculator me-2"></i> Recalculate System</a>
        <hr>
