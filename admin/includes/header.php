...
<body>
    <div class="sidebar">
        ...
        <a href="change_password.php" id="link-change-password" class="<?php echo basename($_SERVER['PHP_SELF']) == 'change_password.php' ? 'active' : ''; ?>"><i class="fa fa-lock me-2"></i> Change Password</a>
        <hr>
