...
<body>
    <div class="sidebar">
        ...
        <a href="change_sponsor.php" id="link-change-sponsor" class="<?php echo basename($_SERVER['PHP_SELF']) == 'change_sponsor.php' ? 'active' : ''; ?>"><i class="fa fa-user-edit me-2"></i> Change Sponsor ID</a>
