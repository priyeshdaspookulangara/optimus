...
<body>
    <div class="sidebar">
        ...
        <a href="bottom_nodes.php" id="link-bottom-nodes" class="<?php echo basename($_SERVER['PHP_SELF']) == 'bottom_nodes.php' ? 'active' : ''; ?>"><i class="fa fa-sitemap me-2"></i> Bottom Nodes</a>
