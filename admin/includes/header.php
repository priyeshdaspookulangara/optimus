...
<body>
    <div class="sidebar">
        ...
        <a href="drag_drop_genealogy.php" id="link-drag-drop-genealogy" class="<?php echo basename($_SERVER['PHP_SELF']) == 'drag_drop_genealogy.php' ? 'active' : ''; ?>"><i class="fa fa-sitemap me-2"></i> Drag & Drop Tree</a>
