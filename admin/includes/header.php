...
<body>
    <div class="sidebar">
        ...
        <a href="reset_slabmatch.php" id="link-reset-slabmatch" class="<?php echo basename($_SERVER['PHP_SELF']) == 'reset_slabmatch.php' ? 'active' : ''; ?>"><i class="fa fa-sync-alt me-2"></i> Reset Slab Match</a>
        <hr>
