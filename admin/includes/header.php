...
<body>
    <div class="sidebar">
        ...
        <a href="change_investment.php" id="link-change-investment" class="<?php echo basename($_SERVER['PHP_SELF']) == 'change_investment.php' ? 'active' : ''; ?>"><i class="fa fa-edit me-2"></i> Change Investment</a>
