...
<body>
    <div class="sidebar">
        ...
        <a href="correct_roi.php" id="link-correct-roi" class="<?php echo basename($_SERVER['PHP_SELF']) == 'correct_roi.php' ? 'active' : ''; ?>"><i class="fa fa-sync-alt me-2"></i> Correct ROI</a>
        <hr>
