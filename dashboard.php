...
// Ceiling Limit Calculation (300% ID Cap removed)
$ceilingBalance = 'UNLIMITED';
$progressPercent = 100;
...
<div class="container-fluid content-inner dashboard-inner pb-5 p-3">
    ...
    <div class="container-fluid">
        <button type="button" class="btn btn-secondary w-100 mb-2 text-uppercase ceiling-limit-btn" style="background: linear-gradient(90deg, rgb(80 71 147) 17%, rgb(79 194 218) 98%); cursor: default;">
            <h3 class="text-center pt-5 pb-5 mb-3 text-uppercase" style="color: #3f2259 !important;">CEILING LIMIT BALANCE: UNLIMITED</h3>
            <div class="progress" style="height: 50px">
                <div class="progress-bar text-bg-success" style="width: 100%">NO CAP LIMIT</div>
            </div>
        </button>
    </div>
